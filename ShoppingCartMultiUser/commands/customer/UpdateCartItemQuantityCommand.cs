...
namespace ShoppingCartMultiUser.commands.customer
{
    ...
    internal class UpdateCartItemQuantityCommand : ICommand
    {
        Application _application;

        public UpdateCartItemQuantityCommand(Application application)
        {
        ...
        {
            if (args.Length < 2) return ($"Invalid number of arguments. Usage: {GetHelp()}");
            ...
            return _application.GetShoppingCartService().UpdateCartItemQuantity(parsedProductId, parsedProductQuantity);
        }
